...
object AppointmentProposals : LongIdTable("scheduling_appointment_proposals") {
    ...
    val bookingReliabilityDecisionId = long("booking_reliability_decision_id").nullable()
    val bookingReliabilityPolicyVersionId = long("booking_reliability_policy_version_id").nullable()
    val bookingReliabilityPolicyHash = varchar("booking_reliability_policy_hash", 64).nullable()
    val bookingReliabilityEvaluationDigest = varchar("booking_reliability_evaluation_digest", 64).nullable()
