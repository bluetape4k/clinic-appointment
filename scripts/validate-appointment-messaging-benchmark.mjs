...
requireValue(typeof report.sourceFile === "string" && report.sourceFile.length > 0, "sourceFile is required");
requireValue(typeof report.sourceFilePattern === "string" && report.sourceFilePattern.length > 0, "sourceFilePattern is required");
