...
- [x] **Step 1: Create a real PostgreSQL fixture.**
...
- [x] **Step 2: Add the bounded lock-timeout test.**
...
- [x] **Step 1: Add a deterministic write-skew fixture.**
...
- [x] **Step 2: Assert fresh retry and lifecycle cleanup.**
...
- [x] **Step 3: Run the serializable test and confirm RED.**
...
- [x] **Step 1: Remove repository-internal retry from `claim`.**
...
- [x] **Step 4: Run the focused GREEN tests.**
...
- [x] **Step 3: Write the Korean lesson.**
...
- [x] **Step 2: Run PostgreSQL Testcontainers validation sequentially.**
...
- [x] **Step 3: Run the complete affected module.**
...
- [x] **Step 4: Run static and scope checks.**
...
- [x] **Step 1: Complete verifier traceability.**
...
- [x] **Step 2: Run six plan/code review lenses in the main session.**
