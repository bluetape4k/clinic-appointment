...
이는 명세 결함이 아니며, 원래 head를 PASS로 소급하지 않는다. PR #215가 `mono {}` Reactor bridge, suspend scheduler, 명시적 nullable invariant로 수정했고 merge commit `9899dac...`를 최종 review head로 고정했다.
