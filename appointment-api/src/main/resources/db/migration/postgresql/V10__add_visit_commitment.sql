-- Versioned visit commitment schema (PostgreSQL).
...
ALTER TABLE scheduling_appointments ALTER COLUMN start_time DROP NOT NULL;
ALTER TABLE scheduling_appointments ALTER COLUMN end_time DROP NOT NULL;
