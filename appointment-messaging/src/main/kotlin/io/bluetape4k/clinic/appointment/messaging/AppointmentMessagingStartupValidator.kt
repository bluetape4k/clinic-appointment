...
/**
 * DataSource가 있는 애플리케이션에서 V22/schema와 serializer 계약을 context startup 때
 * fail-fast로 확인한다. broker outage는 relay readiness 문제이므로 startup을 막지 않는다.
 */
class AppointmentMessagingStartupValidator(
    ...
    override fun afterSingletonsInstantiated() {
        ...
        check(state.schemaValid) { "appointment messaging V22 schema contract is unavailable" }
